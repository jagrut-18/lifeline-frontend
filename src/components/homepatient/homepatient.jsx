...
function HomePatient() {
    ...
    return (
        <div className="row-boxes">
            ...
            <Box onClick={onClick} routeName={"search_package_patient"} image={Insurance} header={"Insurance Packages"} description={"Get yourself an insurance package and save money with these amazing deals."} buttonText={"Explore Plans"} />
